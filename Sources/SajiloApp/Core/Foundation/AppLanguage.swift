...
enum L10n {
    ...
    static let panchangaTitle = LocalizedStringResource("panchanga.title", bundle: .sajiloResources)
    static let panchangaSunrise = LocalizedStringResource("panchanga.sunrise", bundle: .sajiloResources)
    static let panchangaSunset = LocalizedStringResource("panchanga.sunset", bundle: .sajiloResources)
    static let panchangaDaylight = LocalizedStringResource("panchanga.daylight", bundle: .sajiloResources)
    static let panchangaRahuKaal = LocalizedStringResource("panchanga.rahu-kaal", bundle: .sajiloResources)
    static let panchangaRahuNote = LocalizedStringResource("panchanga.rahu-note", bundle: .sajiloResources)
    static let panchangaComputed = LocalizedStringResource("panchanga.computed", bundle: .sajiloResources)
    ...
    static let settingsRadio = LocalizedStringResource("settings.radio", bundle: .sajiloResources)
    ...
    static let toolDate = LocalizedStringResource("tools.date", bundle: .sajiloResources)
    ...
    static let tithi = LocalizedStringResource("calendar.tithi", bundle: .sajiloResources)
    static let upcoming = LocalizedStringResource("screen.upcoming", bundle: .sajiloResources)
    static let eventsFilter = LocalizedStringResource("events.filter", bundle: .sajiloResources)
    static let eventsCurrent = LocalizedStringResource("events.current", bundle: .sajiloResources)
    static let eventsFestivals = LocalizedStringResource("events.festivals", bundle: .sajiloResources)
    static let eventsPublicHolidays = LocalizedStringResource("events.public-holidays", bundle: .sajiloResources)
